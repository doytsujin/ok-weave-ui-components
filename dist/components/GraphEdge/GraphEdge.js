...
var _excluded = ["isAnimated"],
  _excluded2 = ["interpolatedThickness", "interpolatedArrowOffset"];
...
var EdgeShadow = _styledComponents["default"].path.attrs(function (_ref) {
...
var EdgeLine = _styledComponents["default"].path.attrs(function (_ref2) {
...
var EdgeArrowDefinition = function EdgeArrowDefinition(_ref3) {
  ...
  return /*#__PURE__*/_react["default"].createElement("defs", null, /*#__PURE__*/_react["default"].createElement("marker", {
    ...
    viewBox: "1 0 10 10",
    orient: "auto"
  }, /*#__PURE__*/_react["default"].createElement(EdgeArrowPolygon, {
 ...
 */
var GraphEdge = /*#__PURE__*/function (_React$PureComponent) {
  function GraphEdge() {
    var _this;
    ...
    _this = _callSuper(this, GraphEdge, [].concat(args));
  ...
  return _createClass(GraphEdge, [{
    ...
    value: function renderEdge(props) {
      ...
      }, withArrow && /*#__PURE__*/_react["default"].createElement(EdgeArrowDefinition, {
        id: encodedArrowId,
        thickness: arrowThickness,
        offset: arrowOffset,
        contrastMode: contrastMode
      }), /*#__PURE__*/_react["default"].createElement(EdgeShadow, {
        d: path,
        highlighted: highlighted,
        thickness: thickness,
        contrastMode: contrastMode
      }), isDotted && /*#__PURE__*/_react["default"].createElement(EdgeDotted, {
        d: path,
        contrastMode: contrastMode
      }), /*#__PURE__*/_react["default"].createElement(EdgeLine, {
        d: path,
        thickness: thickness,
        contrastMode: contrastMode,
    ...
    value: function render() {
      ...
      if (!isAnimated) {
        return this.renderEdge(_objectSpread(_objectSpread({}, otherProps), {}, {
      ...
      return (
        ...
        _react["default"].createElement(_reactMotion.Motion, {
          style: _objectSpread(_objectSpread({}, this.state.waypointsMap), {}, {
          ...
          var interpolatedThickness = _ref5.interpolatedThickness,
            ...
            interpolatedWaypoints = _objectWithoutProperties(_ref5, _excluded2);
          return _this2.renderEdge(_objectSpread(_objectSpread({}, otherProps), {}, {
...
var _default = exports["default"] = GraphEdge;
