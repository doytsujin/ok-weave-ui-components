...
var MAX_VISIBLE_RANGE_SECS = _moment["default"].duration(2, 'weeks').asSeconds();
...
var TimelineDeployments = /*#__PURE__*/function (_React$PureComponent) {
  function TimelineDeployments(props) {
    var _this;
    _classCallCheck(this, TimelineDeployments);
    _this = _callSuper(this, TimelineDeployments, [props]);
    _this.state = {
  ...
  return _createClass(TimelineDeployments, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react["default"].createElement(DeploymentAnnotations, null, this.state.deployments.map(function (deployment) {
...
var _default = exports["default"] = TimelineDeployments;
//# sourceMappingURL=_TimelineDeployments.js.map