...
var Timeline = /*#__PURE__*/function (_React$PureComponent) {
  function Timeline(props) {
    ...
    _defineProperty(_this, "handlePanStart", function () {
      _this.setState({
        isPanning: true
      });
    });
    _defineProperty(_this, "handlePanEnd", function () {
    ...
    _defineProperty(_this, "handlePan", function () {
    ...
    _defineProperty(_this, "updateVisibleRange", function () {
  ...
  return _createClass(Timeline, [{
    ...
    value: function renderContent(transform) {
      ...
      return /*#__PURE__*/_react["default"].createElement(TimelineContent, null, /*#__PURE__*/_react["default"].createElement(CenteredContent, null, /*#__PURE__*/_react["default"].createElement(_TimelineDeployments["default"], {
        deployments: this.props.deployments,
        linkBuilder: this.props.deploymentsLinkBuilder,
        onClick: this.props.onDeploymentClick,
        timeScale: timeScale,
        width: width
      })), /*#__PURE__*/_react["default"].createElement(OverflowHidden, null, /*#__PURE__*/_react["default"].createElement(CenteredContent, null, /*#__PURE__*/_react["default"].createElement(_TimelineRange["default"], {
        color: _theme["default"].colors.gray200,
        endAt: this.props.earliestTimestamp,
        timeScale: timeScale,
        width: width
      }), /*#__PURE__*/_react["default"].createElement(_TimelineRange["default"], {
        color: _theme["default"].colors.gray200,
        startAt: this.props.timestampNow,
        timeScale: timeScale,
        width: width
      }), this.props.inspectingInterval && /*#__PURE__*/_react["default"].createElement(_TimelineRange["default"], {
        color: _theme["default"].colors.blue400,
        startAt: startTimestamp,
        endAt: focusedTimestamp,
        timeScale: timeScale,
        width: width
      }), /*#__PURE__*/_react["default"].createElement(TimelinePeriodLabelsWrapper, null, ['year', 'month', 'day', 'minute'].map(function (period) {
        return /*#__PURE__*/_react["default"].createElement(_TimelinePeriodLabels["default"], _extends({
          key: period,
          period: period,
          width: width,
      ...
      })), this.props.isLoading && /*#__PURE__*/_react["default"].createElement(_TimelineLoader["default"], {
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react["default"].createElement(TimelineWrapper, null, /*#__PURE__*/_react["default"].createElement(_reactResizeAware["default"], {
        onlyEvent: true,
      ...
      }, /*#__PURE__*/_react["default"].createElement(TimelineContainer, {
        panning: isPanning,
        ref: this.saveSvgRef,
        title: "Scroll to zoom, drag to pan"
      }, this.state.isAnimated ? /*#__PURE__*/_react["default"].createElement(_reactMotion.Motion, {
        style: {
...
//# sourceMappingURL=_Timeline.js.map