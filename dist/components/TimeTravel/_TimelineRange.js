...
var TimelineRangeOverlay = _styledComponents["default"].div.attrs(function (_ref) {
  var x = _ref.x,
    width = _ref.width;
  return {
    style: {
...
var TimelineRange = function TimelineRange(_ref2) {
  ...
  return /*#__PURE__*/_react["default"].createElement(TimelineRangeOverlay, {
    color: color,
    x: startShift,
    width: length
  });
...
var _default = exports["default"] = TimelineRange;
//# sourceMappingURL=_TimelineRange.js.map