...
function getDefaultSeriesNameParts(series) {
  ...
  var metricHash = (0, _omit2["default"])(series.metric, ['__name__']);
...
function getColorTheme(_ref) {
  ...
  return function (index) {
    var colors = _toConsumableArray(_theme["default"].colors.graphThemes[colorTheme]);
 ...
 *
 */
var PrometheusGraph = /*#__PURE__*/function (_React$PureComponent) {
  function PrometheusGraph(_props, context) {
    var _this;
    _classCallCheck(this, PrometheusGraph);
    _this = _callSuper(this, PrometheusGraph, [_props, context]);
    _defineProperty(_this, "handleSelectedLegendKeysChange", function (selectedLegendKeys) {
    ...
    _defineProperty(_this, "handleHoveredLegendKeyChange", function (hoveredLegendKey) {
      _this.setState({
        hoveredLegendKey: hoveredLegendKey
      });
    });
    _defineProperty(_this, "handleHoverUpdate", function (_ref4) {
    ...
    _defineProperty(_this, "handleChartResize", function (_ref5) {
      var chartWidth = _ref5.chartWidth,
        chartHeight = _ref5.chartHeight;
      _this.setState(_objectSpread(_objectSpread({}, _this.prepareTimeAndValueScales(_this.props, _this.state.visibleMultiSeries)), {}, {
        chartHeight: chartHeight,
        chartWidth: chartWidth
      }));
    });
    _defineProperty(_this, "prepareMultiSeries", function (props) {
      ...
      var getSeriesKey = props.getSeriesKey || getDefaultSeriesKey;
      ...
      var multiSeriesKeys = (0, _keys2["default"])(multiSeriesByKey).sort();
      ...
      var timestampSecs = timestampQuantizer.range();
      ...
      var visibleMultiSeries =
      // If no series is selected, show all of them.
      selectedLegendKeys.length === 0 ? multiSeries :
    ...
    _defineProperty(_this, "prepareTimeAndValueScales", function (props, multiseries) {
      var chartWidth;
      var chartHeight;
      if (_this.chartRef) {
  ...
  return _createClass(PrometheusGraph, [{
    ...
    value: function getTimestampQuantizer() {
      ...
      var startTimeSec = props.startTimeSec,
        ...
        stepDurationSec = props.stepDurationSec;
      ...
      var timestampSecs = (0, _range2["default"])(endTimeSec, startTimeSec - 1e-6, -stepDurationSec).sort();
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react["default"].createElement(GraphWrapper, null, /*#__PURE__*/_react["default"].createElement(AxisLabel, {
        loading: loading
      }, yAxisLabel), /*#__PURE__*/_react["default"].createElement(GraphContainer, {
        loading: loading
      }, /*#__PURE__*/_react["default"].createElement(_AxesGrid["default"], {
        hasData: hasData,
        chartWidth: chartWidth,
        chartHeight: chartHeight,
        timeScale: timeScale,
      ...
      }), hasData && /*#__PURE__*/_react["default"].createElement(_DeploymentAnnotations["default"], {
        ...
        chartWidth: chartWidth,
        chartHeight: chartHeight
      }), /*#__PURE__*/_react["default"].createElement(_HoverInfo["default"], {
        mouseX: hoverX,
        mouseY: hoverY,
        ...
        multiSeries: multiSeries
      }), /*#__PURE__*/_react["default"].createElement(_ErrorOverlay["default"], {
        hasData: hasData,
        loading: loading,
        error: error
...
var _default = exports["default"] = PrometheusGraph;
//# sourceMappingURL=PrometheusGraph.js.map